...
const CvgenieIntro = () => {
    ...
    return (
        <>
            <AffNav />
            <div className='mt-4'>
                <h1 className='text-center font-bold text-2xl sm:text-2xl lg:text-5xl'>CV~Genie</h1>
            </div>
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
                        <div className="md:pt-8 my-auto">
                            ...
                            <p className="mb-6 text-gray-500 sm:text-sm md:mb-8">
                                <span className="text-indigo-600 font-bold">CV~Genie</span>,  revolutionizes the resume creation process by offering a user-friendly platform that generates professionally tailored CVs. Our innovative system ensures that every resume is not only visually appealing but also optimized for Applicant Tracking Systems (ATS), enhancing your chances of landing interviews. Gone are the days of struggling with generic templates; CV Genie crafts each resume to highlight your individual skills, experiences, and achievements..
                                <br />
                                <br />
                                Our platform simplifies the entire CV writing process, guiding users through each step with ease. From inputting personal information to selecting relevant job experiences and skills, CV Genie streamlines the process, saving you valuable time and effort. Moreover, our extensive database of industry-specific keywords and phrases ensures that your resume aligns perfectly with the expectations of potential employers and ATS algorithms
                                <br />
                                <br />
                                With CV Genie, you can trust that your resume will stand out from the crowd. Our team of experts continually updates our platform to reflect the latest trends and best practices in resume writing and ATS optimization. Whether you're a seasoned professional or just starting your career journey, CV Genie empowers you to present yourself in the best possible light, increasing your chances of securing your dream job.
                            </p>
                        </div>
                        <div>
                            <div className=" relative mx-10 my-10 flex justify-center items-center rounded-lg ">
                                <img
                                    src="https://static-cse.canva.com/blob/1395053/1131w-Q-tiO_0DLCw.jpg"
                                    loading="lazy"
                                    alt="Photo by Martin Sanchez"
                                    className=" w-1/2 shadow-lg top-8 left-20 rounded-lg hover:left-4 hover:top-16 transition-all absolute z-10"
                                />
                                <img
                                    src="https://template.canva.com/EADaozQLBP8/1/0/309w-U9BqhECJarg.jpg"
                                    loading="lazy"
                                    alt="Photo by Martin Sanchez"
                                    className=" w-1/2 shadow-lg rounded-lg z-0 "
                                />
                            </div>
                ...
                >
                    <section className="rounded-3xl shadow-xl bg-white w-1/2 sm:w-1/2  lg:w-1/4 md:w-1/2">
                        <div className="p-2 lg:p-2 md:p-12 text-center sm:p-12">
                            <h2 className="mt-6 text-sm lg:text-md md:sm sm:text-sm ">
