...
const EditPopUp = () => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://https://referbiz-web.onrender.com:8080/api/employee-rb/my-associates/get-cv-data/${id}`,
          {
            headers: {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://https://referbiz-web.onrender.com:8080/api/employee-rb/my-associates-data/update-shortlisted-cv-sharing/${id}`,
  ...
  const handleJoined = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://https://referbiz-web.onrender.com:8080/api/employee-rb/my-associates-data/update-joined-cv-sharing/${id}`,
