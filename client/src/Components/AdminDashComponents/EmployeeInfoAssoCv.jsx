    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `http://https://referbiz-web.onrender.com:8080/api/admin-rb/admin-associates-data/get-cv-data/${cand}`,
          {
            headers: {
...
export default EmployeeInfoAssoCv;
