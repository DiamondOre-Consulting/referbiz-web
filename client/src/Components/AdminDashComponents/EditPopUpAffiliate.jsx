...
const EditPopUpAffiliate = () => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://referbiz-web-backend.onrender.com/api/admin-rb/admin-affiliates-data/get-cv-data/${id}`,
          {
            headers: {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web-backend.onrender.com/api/admin-rb/admin-affiliates-data/update-shortlisted-cv-sharing/${id}`,
  ...
  const handleJoined = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web-backend.onrender.com/api/admin-rb/admin-affiliates-data/update-joined-cv-sharing/${id}`,
  ...
  const handleappeared = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web-backend.onrender.com/api/admin-rb/admin-affiliates-data/update-appeared-cv-sharing/${id}`,
        { isAppeared: formValues.isAppeared },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleoffered = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web-backend.onrender.com/api/admin-rb/admin-affiliates-data/update-offered-cv-sharing/${id}`,
        { isOffered: formValues.isOffered },
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default EditPopUpAffiliate;
