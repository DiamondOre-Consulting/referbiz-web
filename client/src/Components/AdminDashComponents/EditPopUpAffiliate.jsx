...
const EditPopUpAffiliate = () => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://referbiz-web.onrender.com:8080/api/admin-rb/admin-affiliates-data/get-cv-data/${id}`,
          {
            headers: {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web.onrender.com:8080/api/admin-rb/admin-affiliates-data/update-shortlisted-cv-sharing/${id}`,
  ...
  const handleJoined = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://referbiz-web.onrender.com:8080/api/admin-rb/admin-affiliates-data/update-joined-cv-sharing/${id}`,
