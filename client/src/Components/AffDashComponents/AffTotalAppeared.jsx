    ...
    useEffect(() => {
        ...
        const fetchAllAppeared = async () => {
            try {
                ...
                const response = await axios.get('https://referbiz-web-backend.onrender.com/api/candidates/my-appeared-refs', {
                    headers: {
                            ...
                            afftototalapp.map((app) => {
                                return (
                                    <tr class="bg-gray-100 border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                                        ...
                                        <td class="px-6 py-4">
                                            {app.refUniqueEmailId}
                                        </td>
                                        <td class="px-6 py-4">
                                            {app.refPhone}
                                        </td>
                                        <td class="px-6 py-4">
                                            <a href={app.PDF} target="_blank" className='text-blue-600 underline'> veiw </a>
                                        </td>
                                    </tr>
                                )
                            })
...
export default AffTotalAppeared