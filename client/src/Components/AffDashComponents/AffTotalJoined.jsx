        ...
        const fetchAllJoined = async () => {
            try {
                ...
                if (response.status === 200) {
                    ...
                    setAffTotalJoined(response.data);
                            ...
                            afftototaljoined.map((joined) => {
                                return (
                                    <tr class="bg-gray-100 border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                                        ...
                                        <td class="px-6 py-4">
                                            {joined.refUniqueEmailId}
                                        </td>
                                        <td class="px-6 py-4">
                                            {joined.refPhone}
                                        </td>
                                        <td class="px-6 py-4">
                                            <a href={joined.PDF} target="_blank" className='text-blue-600 underline'> veiw </a>
                                        </td>
                                    </tr>
                                )
                            })
